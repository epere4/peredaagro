/*
 *  Sudo Slider ver 2.1.4 - jQuery plugin 
...
(function($)
{
	$.fn.sudoSlider = function(optionsOrg)
	{
		...
		defaults = {
			controlsShow:      falsev, /* option[0]/*controlsShow*/
			...
			speed:             400, /* option[7]/*speed*/
			ease:              'swing', /* option[8]/*ease*/
			auto:              falsev, /* option[9]/*auto*/
			pause:             48000, /* option[10]/*pause*/
			...
			firstHtml:         falsev,/*'<a href="#" class="firstBtn"> first </a>', /* option[36]/*firstHtml*/
			controlsAttr:      'id="controls"', /* option[37]/*controlsAttr*/
			lastHtml:          falsev,/*'<a href="#" class="lastBtn"> last </a>', /* option[38]/*lastHtml*/
